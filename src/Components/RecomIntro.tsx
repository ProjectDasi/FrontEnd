    ...
    <div className="w-full h-screen Gamtan bg-[url('./assets/images/IntroBG.jpg')] bg-cover">
      <div className='bg-black bg-opacity-60 h-screen'>
            ...
            <Fade damping={0.1}>
                ...
                <button type="button" className='rounded-3xl py-2 px-5 text-white GamtanBold text-2xl border-4 border-white border-solid flex items-center hover:bg-white hover:bg-opacity-20 transition duration-200'>이력서 등록하기</button>
                <button type="button" className='ml-10 rounded-3xl py-2 px-5 text-white GamtanBold text-2xl border-4 border-white border-solid flex items-center hover:bg-white hover:bg-opacity-20 transition duration-200'>지금 시작하기<svg className="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg></button>
                </div>
